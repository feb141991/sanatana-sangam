...
export default function TopBar({
  ...
  return (
    <>
      <header className="sticky top-0 z-40 overflow-x-hidden px-3 pt-3">
        <div className="glass-nav max-w-2xl mx-auto min-w-0 px-3 sm:px-4 h-14 rounded-[1.65rem] flex items-center gap-2 overflow-hidden" style={shellTint}>
