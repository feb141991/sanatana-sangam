...
function UpgradePill({ compact, onClick }: { compact?: boolean; onClick: () => void }) {
  if (compact) {
    return (
      <button
        ...
        style={{
          background: 'linear-gradient(135deg, rgba(197, 160, 89,0.18), rgba(180,120,10,0.18))',
  ...
  return (
    <button
      ...
      style={{
        background: 'linear-gradient(135deg, rgba(197, 160, 89,0.12), rgba(180,120,10,0.10))',
