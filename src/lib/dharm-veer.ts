 ...
 *
 * A new hero surfaces on the home card every 3 days via getDharmVeerOfTheDay().
 * ─────────────────────────────────────────────────────────────────────────────
 */
...
export const DHARM_VEERS: DharmVeer[] = [
  ...
  // ── 17. Bhai Ghanaya ──────────────────────────────────────────────────────
  {
    ...
    quote: {
      ...
      attribution: 'Bhai Ghanaya, traditional account',
    },
  },
  ...
  // ── 19. Bhai Kanhaiya (already covered as Bhai Ghanaya) — replace with Chandragupta & Chanakya
  {
    id: 'chanakya',
    name: 'Chanakya',
    era: '350–283 BCE',
  ...
  // ── 20. Ajita Kesakambali (the forgotten anti-hero who sharpens the tradition) ──
  {
    id: 'ramanuja',
    name: 'Ramanujacharya',
    era: '1017–1137 CE',
...
/**
 * Returns the Dharm Veer for today. Changes every 3 calendar days.
...
export function getDharmVeerOfTheDay(userTradition?: string | null): DharmVeer {
  ...
  const slot  = Math.floor(dayN / 3); // one hero per 3 days
...
/** Tradition display metadata */
export const TRADITION_META: Record<string, { label: string; emoji: string; color: string }> = {
  hindu:    { label: 'Hindu',    emoji: '🕉️', color: 'rgba(200,146,74,0.15)' },
  sikh:     { label: 'Sikh',     emoji: '☬',  color: 'rgba(74,120,200,0.15)' },
  buddhist: { label: 'Buddhist', emoji: '☸️', color: 'rgba(120,180,100,0.15)' },
  jain:     { label: 'Jain',     emoji: '🤲', color: 'rgba(180,140,200,0.15)' },
};
