...
export const DAILY_FALLBACK_QUIZ: Record<string, Record<string, DailyFallbackQuiz[]>> = {
  ...
  pa: {
    ...
    buddhist: [{
      question: 'ਭਗਵਾਨ ਬੁੱਧ ਨੇ ਗਿਆਨ ਪ੍ਰਾਪਤੀ ਤੋਂ ਬਾਅਦ ਆਪਣਾ ਪਹਿਲਾ ਉਪਦੇਸ਼ ਕਿਸ ਸਥਾਨ ਤੇ ਦਿੱਤਾ ਸੀ?',
      options: ['ਸਾਰਨਾਥ', 'ਬੋਧ ਗਯਾ', 'ਕੁਸ਼ੀਨਗਰ', 'ਲੁੰਬਿਨੀ'],
      answerIndex: 0,
      explanation: 'ਭਗਵਾਨ ਬੁੱਧ ਨੇ ਸਾਰਨਾਥ ਵਿਖੇ ਆਪਣੇ ਪਹਿਲੇ ਪੰਜ ਚੇਲਿਆਂ ਨੂੰ ਧਰਮਚੱਕਰ ਪ੍ਰਵਰਤਨ ਸੂਤਰ ਦਾ ਉਪਦੇਸ਼ ਦਿੱਤਾ ਸੀ।',
      fact: 'ਇਸ ਪਹਿਲੇ ਉਪਦੇਸ਼ ਵਿੱਚ ਚਾਰ ਆਰੀਆ ਸੱਚ ਅਤੇ ਅਸ਼ਟਾਂਗਿਕ ਮਾਰਗ ਦੀ ਸਿੱਖਿਆ ਦਿੱਤੀ ਗਈ ਸੀ।',
      source: 'ਧੰਮਚੱਕੱਪਵੱਤਨਾ ਸੁੱਤ',
    }],
    all: [{
