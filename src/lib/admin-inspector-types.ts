...
export interface DharmVeerRecord {
  ...
  taglinePa?: string | null;
  journey: string;
  journeyLocal?: string | null;
  journeyPa?: string | null;
  trial: string;
  trialLocal?: string | null;
  trialPa?: string | null;
  teaching: string;
  teachingLocal?: string | null;
  teachingPa?: string | null;
  moral: string;
  moralLocal?: string | null;
  moralPa?: string | null;
  legacy?: string | null;
  legacyLocal?: string | null;
  legacyPa?: string | null;
  quote?: string | null;
