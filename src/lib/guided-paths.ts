...
export const GUIDED_PLANS: GuidedPlan[] = [
  {
    ...
    subtitle: '7-Day Dawn Awakening',
    emoji: '🌅',
    duration: 7,
    tradition: 'all',
    difficulty: 'beginner',
    tagline: 'Rise before the world. Build the habit that changes everything.',
    description: 'Seven mornings of sacred rising. Each day adds one layer of practice until your full Nitya Karma flows naturally from the moment you wake.',
    accentColor: '#C8924A',
    borderColor: 'rgba(200,146,74,0.22)',
    days: [
      { day: 1, title: 'The Sacred Rise', focus: 'Waking',     practice: 'Set alarm for Brahma Muhurta. Wake, sit upright in bed, say your deity\'s name three times before touching your phone.', duration: 5 },
      { day: 2, title: 'Snana & Clarity', focus: 'Purification', practice: 'Cold water snana with intention. Before entering the bath, set one sankalpa for the day.', duration: 15 },
      { day: 3, title: 'Tilak & Simran',  focus: 'Awakening',  practice: 'Apply tilak (or simran). Look in the mirror and recall your dharmic identity for 2 minutes.', duration: 10 },
      { day: 4, title: 'First Japa',      focus: 'Mantra',     practice: 'Sit for one mala (108 rounds) of your chosen mantra before any other activity.', duration: 20 },
      { day: 5, title: 'Sandhya',         focus: 'Prayer',     practice: 'Add morning Sandhya Vandana or Surya Namaskar — greet the rising sun with the full sequence.', duration: 20 },
      { day: 6, title: 'Shloka Paath',    focus: 'Scripture',  practice: 'Read or recite one chapter from your chosen scripture. Carry one verse with you through the day.', duration: 15 },
      { day: 7, title: 'Full Sequence',   focus: 'Integration',practice: 'Complete your full Nitya Karma sequence from start to finish — all seven steps, no shortcuts.', duration: 60 },
    ],
  },
  {
