...
export type FestivalVerificationType = 'solar_fixed' | 'lunar_tithi' | 'nakshatra_based' | 'regional_calendar' | 'historical_commemoration' | 'solar_sankranti' | 'solar_month_day' | 'lunar_tithi_span';
