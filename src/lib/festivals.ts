...
export const FESTIVALS_2026: Festival[] = [
  ...
  { name: 'Holi',                 date: '2026-03-04', emoji: '🎨', description: 'Festival of colours celebrating victory of good over evil',          type: 'major',    tradition: 'hindu' },
  ...
  { name: 'Vat Savitri Vrat',     date: '2026-05-16', emoji: '🌳', description: 'Vrat observed by married women for the well-being of their husbands (Jyeshtha Amavasya — North India)', type: 'vrat', tradition: 'hindu' },
  ...
  { name: 'Navratri begins',      date: '2026-10-11', emoji: '🪔', description: 'Nine nights of worship of Goddess Durga, Lakshmi and Saraswati',     type: 'major',    tradition: 'hindu' },
  { name: 'Dussehra',             date: '2026-10-20', emoji: '🎇', description: 'Victory of Rama over Ravana — triumph of good over evil',            type: 'major',    tradition: 'hindu' },
  ...
  { name: 'Dhanteras',            date: '2026-11-06', emoji: '💰', description: 'First day of Diwali festival — worship of Goddess Lakshmi',          type: 'major',    tradition: 'hindu' },
  { name: 'Diwali',               date: '2026-11-08', emoji: '🎆', description: 'Festival of lights — celebrated by Hindu, Jain and Sikh communities', type: 'major',    tradition: 'all'   },
  { name: 'Govardhan Puja',       date: '2026-11-09', emoji: '⛰️', description: 'Worship of Govardhan Hill and Lord Krishna',                         type: 'major',    tradition: 'hindu' },
  { name: 'Bhai Dooj',            date: '2026-11-10', emoji: '👫', description: 'Celebration of the bond between brothers and sisters',                type: 'major',    tradition: 'hindu' },
  ...
  { name: 'Kartik Purnima',       date: '2026-11-22', emoji: '🪷', description: 'Full moon of Kartik month — extremely auspicious for bathing',       type: 'vrat',     tradition: 'hindu' },
  ...
  { name: 'Guru Arjan Dev Martyrdom',        date: '2026-06-18', emoji: '☬',  description: 'Shaheedi Diwas — remembrance of the martyrdom of Guru Arjan Dev Ji, 5th Guru and compiler of the Adi Granth', type: 'major', tradition: 'sikh' },
  { name: 'Guru Har Krishan Gurpurab',       date: '2026-08-07', emoji: '☬',  description: 'Birth anniversary of Guru Har Krishan Ji — 8th Sikh Guru who became Guru at age 5', type: 'regional', tradition: 'sikh' },
  ...
  { name: 'Bandhi Chhor Divas',              date: '2026-11-08', emoji: '☬',  description: 'Sikh celebration of freedom — marks Guru Hargobind Ji\'s release from Gwalior Fort along with 52 kings. Coincides with Diwali.', type: 'major', tradition: 'sikh' },
  ...
  { name: 'Vesak / Buddha Purnima',           date: '2026-05-01', emoji: '🪷', description: 'The most sacred Buddhist observance — marking the birth, enlightenment and Parinirvana of the Buddha on the full moon of Vaisakha', type: 'major', tradition: 'buddhist' },
  { name: 'Asalha Puja',                      date: '2026-07-29', emoji: '☸️', description: 'Dharma Day — commemorates the Buddha\'s first turning of the Wheel of Dharma, teaching the Four Noble Truths to five ascetics at Sarnath', type: 'major', tradition: 'buddhist' },
  { name: 'Vassa begins (Rains Retreat)',      date: '2026-07-30', emoji: '🌧️', description: 'Beginning of the three-month Buddhist Rains Retreat — monks remain in monasteries for intensive meditation, study and teaching', type: 'major', tradition: 'buddhist' },
  { name: 'Ullambana (Ancestor Day)',          date: '2026-09-23', emoji: '🪔', description: 'East Asian Buddhist observance for honouring ancestors and transferring merit to departed souls — held on the 15th day of the 7th lunar month', type: 'major', tradition: 'buddhist' },
  ...
  // ── Jain ───────────────────────────────────────────────────────────────────
  { name: 'Mahavir Jayanti',                  date: '2026-03-31', emoji: '🤲', description: 'Birth anniversary of Bhagwan Mahavira — the 24th and last Tirthankara of the current cosmic cycle, born in 599 BCE', type: 'major',    tradition: 'jain' },
  ...
  { name: 'Paryushana Parva begins',          date: '2026-08-30', emoji: '🤲', description: 'The holiest Jain festival — 8 days (Shvetambara) of intensive fasting, prayer, scripture study and self-purification. The apex of the Jain spiritual year.', type: 'major', tradition: 'jain' },
  { name: 'Samvatsari (Paryushana ends)',     date: '2026-09-06', emoji: '🕊️', description: 'Samvatsari — the Jain day of universal forgiveness. Micchami Dukkadam: may all wrongdoing be forgiven. Jains seek and grant forgiveness from everyone.', type: 'major', tradition: 'jain' },
  { name: 'Das Lakshana Dharma begins',       date: '2026-09-06', emoji: '🤲', description: 'Digambara Jain equivalent of Paryushana — 10 days of meditation on the ten supreme virtues: forgiveness, humility, honesty, purity, truth, restraint, austerity, renunciation, non-attachment and celibacy', type: 'major', tradition: 'jain' },
  { name: 'Jain New Year (Pratipada)',        date: '2026-11-09', emoji: '🤲', description: 'Jain New Year — the day after Diwali marks the beginning of the Jain calendar year, following the Nirvana of Bhagwan Mahavira', type: 'major', tradition: 'jain' },
  { name: 'Jain Diwali (Nirvana Ladnun)',     date: '2026-11-08', emoji: '🤲', description: 'Jain Diwali — marks the Nirvana (liberation) of Bhagwan Mahavira in 527 BCE at Pavapuri. Observed with lamp-lighting, fasting and scripture recitation.', type: 'major', tradition: 'jain' },
  { name: 'Kartik Purnima (Jain)',            date: '2026-11-22', emoji: '🌕', description: 'Sacred full moon — commemorates the Nirvana of Bhagwan Rishabhanatha (Adinath), the first Tirthankara. A day for fasting and pilgrimage.', type: 'major', tradition: 'jain' },
