...
export const HOME_HERO_THEMES: HomeHeroTheme[] = [
  ...
  },
  {
    ...
    heroAlt: 'Devotional Onam evening lamp and temple courtyard backdrop',
    objectPosition: '50% 25%',
    traditions: ['hindu'],
    festivalSlugs: ['onam', 'thiruvonam'],
    priority: 120,
  },
  {
    id: 'vivah-panchami',
    ...
    heroAlt: 'Devotional Vivah Panchami sacred Vedic mandap havan backdrop',
    objectPosition: '50% 25%',
    traditions: ['hindu'],
    festivalSlugs: ['vivah-panchami', 'sita-ram-vivah'],
    priority: 120,
  },
  {
    id: 'vaikunta-ekadashi',
    label: 'Vaikunta Ekadashi',
  ...
  },
  {
    ...
    label: 'Anant Chaturdashi / Ganesh Visarjan',
    heroImage: '/assets/images/heroes/hindu/anant-chaturdashi-shesha.webp',
    heroAlt: 'Devotional Anant Padmanabha cosmic Sheshanaga backdrop',
    objectPosition: '50% 25%',
    traditions: ['hindu'],
    festivalSlugs: ['anant-chaturdashi', 'anant-chaturdashi-ganesh-visarjan', 'ganesh-visarjan'],
    priority: 120,
  },
  {
    id: 'kartik-purnima',
    label: 'Kartik Purnima / Dev Deepawali',
  ...
  {
    id: 'chintpurni-devi',
    label: 'Chintpurni Mata Navratri',
