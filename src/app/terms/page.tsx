...
export default function TermsPage() {
  return (
    <PublicPageShell
      ...
      asideBody="Operating globally, we commit to the highest standards of user safety and data integrity, respecting the unique legal landscapes of every region we serve."
    >
      <TermsClient />
    </PublicPageShell>
  );
