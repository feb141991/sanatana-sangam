      ...
      <div className="glass-panel rounded-[1.6rem] px-4 py-4 sm:rounded-[1.8rem] sm:px-5 sm:py-5">
        ...
        <div className="mt-3 flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
          <div>
            ...
            <p className="hidden sm:block text-sm text-gray-600 leading-relaxed mt-2 max-w-xl">{meta.description}</p>
          </div>
                ...
                {group.sectionIds.map((sectionId) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <p className="hidden sm:block text-sm text-gray-600 leading-relaxed mt-2">{section.desc}</p>
