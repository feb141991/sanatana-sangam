...
import { MobileList, MobileListItem, MobileScreen, MobileScreenHeader } from '@shared-core/ui/mobile';
  ...
  return (
    <MobileScreen>
      ...
      <MobileScreenHeader
        ...
        description={
          selectedThread
            ...
            : 'A dedicated shell for Kul, Mandali, and direct conversations.'
        }
      />
      ...
      <div className="space-y-4 md:grid md:grid-cols-[0.92fr_1.28fr] md:gap-4 md:space-y-0">
        ...
        >
          <MobileList className="space-y-0 border-0 bg-transparent">
            {threads.map((thread) => {
              const active = selectedThread?.id === thread.id;
              return (
                <MobileListItem key={thread.id} className="px-0 py-0 first:pt-0 last:pb-0 last:border-b-0 border-b-0">
                  <button
                    type="button"
        ...
        >
          {selectedThread ? (
            <>
              ...
              <MobileList className="space-y-3 border-0 bg-transparent">
                <MobileListItem className="space-y-3 border-b-0 px-0 py-0">
