 ...
 * full 1080 × 1920 PNG from the same generator the app surfaces use. The
 * route is development-only; this client only renders canvases in the browser.
 */
  ...
  return (
    <div className="min-h-screen px-5 pb-24 pt-8" style={{ background: 'var(--divine-bg, #12100b)' }}>
      <header className="mx-auto mb-7 max-w-3xl text-center">
        <h1 className="text-2xl font-bold" style={{ color: 'var(--premium-ivory)' }}>
          Share Card Preview
        </h1>
        <p className="mt-1 text-sm" style={{ color: 'var(--premium-gold)' }}>
