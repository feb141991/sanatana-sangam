...
export const metadata: Metadata = {
  ...
  description:
    "Verified source and rights information for sacred texts published by Shoonaya.",
      ...
      {disclosures.map((item) => (
        ...
        >
          <h2 className="font-display text-xl font-semibold capitalize">
            {item.sectionId.replaceAll("_", " ")}
          </h2>
          <p className="mt-1 text-xs font-semibold uppercase tracking-wider text-[var(--brand-primary-strong)]">
            {item.rightsLabel}
          </p>
