...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    {
      url: `${BASE_URL}/features/daily-sadhana`,
      changeFrequency: "monthly",
      priority: 0.8,
    },
    {
      url: `${BASE_URL}/features/sacred-calendar`,
      changeFrequency: "monthly",
      priority: 0.8,
    },
    {
      url: `${BASE_URL}/features/japa`,
      changeFrequency: "monthly",
      priority: 0.8,
    },
    {
      url: `${BASE_URL}/features/pathshala`,
      changeFrequency: "monthly",
      priority: 0.8,
    },
    {
      url: `${BASE_URL}/features/mandali`,
      changeFrequency: "monthly",
      priority: 0.8,
    },
    {
      url: `${BASE_URL}/features/tirtha`,
      changeFrequency: "monthly",
      priority: 0.7,
    },
    {
      url: `${BASE_URL}/features/family-lineage`,
      changeFrequency: "monthly",
      priority: 0.7,
    },
    {
      url: `${BASE_URL}/traditions/hindu`,
      changeFrequency: "monthly",
      priority: 0.8,
    },
    {
      url: `${BASE_URL}/traditions/sikh`,
      changeFrequency: "monthly",
      priority: 0.8,
    },
    {
      url: `${BASE_URL}/traditions/buddhist`,
      changeFrequency: "monthly",
      priority: 0.8,
    },
    {
      url: `${BASE_URL}/traditions/jain`,
      changeFrequency: "monthly",
      priority: 0.8,
    },
    ...
    {
      url: `${BASE_URL}/bhakti/aarti`,
      changeFrequency: "weekly",
      priority: 0.7,
    },
    {
      url: `${BASE_URL}/bhakti/browse`,
      changeFrequency: "weekly",
      priority: 0.8,
    },
    {
      url: `${BASE_URL}/bhakti/katha`,
      changeFrequency: "weekly",
      priority: 0.8,
    },
  ...
  const vratRoutes: MetadataRoute.Sitemap = Object.keys(VRAT_DATABASE).map(
    (slug) => ({
  ...
  try {
    ...
    if (supabaseUrl && supabaseKey) {
      ...
      if (nameStoryRows) {
        nameStoryRoutes = nameStoryRows
          .filter((item) => item.share_slug)
          .map((item) => ({
            url: `${BASE_URL}/name/${item.share_slug}`,
            ...(item.generated_at
              ? { lastModified: new Date(item.generated_at) }
              : {}),
            changeFrequency: "monthly",
            priority: 0.5,
          }));
    ...
    console.warn(
      "Warning: could not fetch dynamic routes for build-time sitemap, falling back to static routes:",
      err,
    );
  }
