  ...
  try {
    ...
    return NextResponse.json(response, {
      ...
      headers: {
        ...
        // parameter (including `tz`, since resolveSpiritualDateTimezone falls back to
        // it for guests) -- no cookie/profile state -- so the response is a pure
        // function of the URL and is safe for the edge/CDN to cache and serve to
        // other guests.
