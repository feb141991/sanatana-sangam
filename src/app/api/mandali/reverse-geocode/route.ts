...
// Pure fetch-proxy to an external geocoding API, no DB/Node dependency --
// runs at the nearest edge PoP instead of being routed to the single Node
// region (dub1) for every call, and closer to the external API too.
