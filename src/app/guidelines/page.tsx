...
export default function GuidelinesPage() {
  return (
    ...
    >
      <section>
        <h2 className="font-display text-2xl font-semibold text-gray-900 mb-2">Lead With Respect</h2>
        <p>
      ...
      <section>
        <h2 className="font-display text-2xl font-semibold text-gray-900 mb-2">No Harassment Or Hate</h2>
        <p>
      ...
      <section>
        <h2 className="font-display text-2xl font-semibold text-gray-900 mb-2">Protect Family And Private Data</h2>
        <p>
      ...
      <section>
        <h2 className="font-display text-2xl font-semibold text-gray-900 mb-2">Avoid Dangerous Misinformation</h2>
        <p>
      ...
      <section>
        <h2 className="font-display text-2xl font-semibold text-gray-900 mb-2">Honor The Purpose Of The Space</h2>
        <p>
