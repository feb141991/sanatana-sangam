...
export const metadata: Metadata = {
  ...
  description:
    "Contact Shoonaya for account support, safety concerns, product questions, and dharmic community partnerships.",
  alternates: {
  ...
  return (
    ...
    >
      ...
      <section>
        ...
        <p>
          Safety concerns, abuse, impersonation, and harmful content should be
          routed through a dedicated support and moderation workflow. This page
          is the public destination for those requests until in-app reporting is
          fully implemented.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          Temple organizers, satsang leaders, and community builders should also
          be able to use this page to reach the team for early partnerships and
          pilot programs.
        </p>
      </section>
    </PublicPageShell>
