                ...
                >
                  ...
                  <div className="pt-6 border-t border-black/5 space-y-3">
                    <div className="p-4 rounded-2xl bg-amber-50/60 border border-amber-200/80 space-y-2 text-xs">
                      <span className="text-[10px] font-bold uppercase tracking-wider text-amber-800 block">Live Seeker Dossier</span>
                      <p className="text-gray-600">
                        View real-time multi-domain activity across Japa, Nitya Karma, Moods, Vrats, and Notification delivery traces.
                      </p>
                    </div>
                  </div>
