...
|---|---|---|---|---|
| `ram-navami` (2026) | #3, 2026-03-26 (Thu) | 2026-03-27 | 1 day | **Diagnosed 2026-08-17 (D34), not fixed.** Not a vṛddhi tithi — `calculatePanchang` at sub-hourly resolution shows Navami begins ~11:30-12:00 IST on 2026-03-26 (right at solar noon), fully absent at that day's sunrise. Classical "madhyahna-vyapini navami" convention would give 2026-03-26, matching the source; the engine only implements the sunrise-prevailing default. Real engine work, not a data fix — see D34. |
| `ganesh-chaturthi` (2026) | #41, 2026-09-14 (Mon) | 2026-09-15 | 1 day | **Diagnosed 2026-08-17 (D34), not fixed.** Same pattern: Chaturthi begins ~07:00-07:30 IST on 2026-09-14, well before noon, absent at sunrise. Ganesh Chaturthi's classical rule is widely documented as madhyahna-vyapini — matches the source once that reference-time is used. See D34. |
| `samvatsari-paryushana-ends` (2026) | #42, 2026-09-15 (Tue) — but the source itself lists two paksha variants (Chaturthi-paksha, Panchami-paksha) at the same single printed date, which is itself suspicious (these usually differ by a day in real Jain practice) | 2026-09-16 | 1 day, plus source-internal ambiguity | **Diagnosed 2026-08-17 (D34), not fixed.** Same pattern again: Pañcamī begins ~07:30-08:00 IST on 2026-09-15, before noon. Consistent with a madhyahna-type reference for this rule too, though the source's own paksha ambiguity (noted at left) is separate and still unresolved. See D34. |
