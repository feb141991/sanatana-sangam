...
INSERT INTO festivals (name, date, emoji, description, type, year) VALUES
  ...
  ('Holi',                 '2026-03-04', '🎨', 'Festival of colours celebrating victory of good over evil',     'major',    2026),
  ...
  ('Buddha Purnima',       '2026-05-01', '🪷', 'Full moon marking the birth and enlightenment of the Buddha',  'major',    2026),
  ('Vat Savitri Vrat',     '2026-05-22', '🌳', 'Vrat observed by married women for the well-being of husbands','vrat',     2026),
  ('Jagannath Rath Yatra', '2026-07-16', '🛕', 'Grand chariot procession of Lord Jagannath at Puri',            'major',    2026),
  ...
  ('Raksha Bandhan',       '2026-08-28', '🧿', 'Festival celebrating the bond between brothers and sisters',    'major',    2026),
  ('Krishna Janmashtami',  '2026-09-03', '🦚', 'Celebration of the birth of Lord Krishna at midnight',          'major',    2026),
  ('Ganesh Chaturthi',     '2026-09-14', '🐘', '10-day festival celebrating the birth of Lord Ganesha',         'major',    2026),
  ...
  ('Navratri begins',      '2026-10-11', '🪔', 'Nine nights of worship of Goddess Durga, Lakshmi & Saraswati', 'major',    2026),
  ('Dussehra',             '2026-10-20', '🎇', 'Victory of Rama over Ravana — triumph of good over evil',       'major',    2026),
  ('Karva Chauth',         '2026-10-15', '🌙', 'Vrat observed by married Hindu women for their husbands',       'vrat',     2026),
  ('Dhanteras',            '2026-11-06', '💰', 'First day of Diwali — worship of Goddess Lakshmi',              'major',    2026),
  ('Diwali',               '2026-11-08', '🎆', 'Festival of lights — victory of light over darkness',           'major',    2026),
  ('Govardhan Puja',       '2026-11-09', '⛰️', 'Worship of Govardhan Hill and Lord Krishna',                    'major',    2026),
  ('Bhai Dooj',            '2026-11-10', '👫', 'Celebration of the bond between brothers and sisters',          'major',    2026),
  ('Chhath Puja',          '2026-11-02', '☀️', 'Worship of the Sun God and Chhathi Maiya',                      'regional', 2026),
  ('Kartik Purnima',       '2026-11-22', '🪷', 'Full moon of Kartik month — extremely auspicious for bathing',  'vrat',     2026),
...
INSERT INTO festivals (name, date, emoji, description, type, tradition, source_kind, review_status)
SELECT 'Ullambana (Ancestor Day)', '2026-09-23', '🪔',
       ...
       'major', 'buddhist', 'curated', 'reviewed'
WHERE NOT EXISTS (SELECT 1 FROM festivals WHERE name = 'Ullambana (Ancestor Day)' AND date = '2026-09-23');
...
INSERT INTO festivals (name, date, emoji, description, type, tradition, source_kind, review_status)
SELECT 'Das Lakshana Dharma begins', '2026-09-06', '🤲',
       ...
       'major', 'jain', 'curated', 'reviewed'
WHERE NOT EXISTS (SELECT 1 FROM festivals WHERE name = 'Das Lakshana Dharma begins' AND date = '2026-09-06');

INSERT INTO festivals (name, date, emoji, description, type, tradition, source_kind, review_status)
SELECT 'Jain New Year (Pratipada)', '2026-11-09', '🤲',
       ...
       'major', 'jain', 'curated', 'reviewed'
WHERE NOT EXISTS (SELECT 1 FROM festivals WHERE name = 'Jain New Year (Pratipada)' AND date = '2026-11-09');
