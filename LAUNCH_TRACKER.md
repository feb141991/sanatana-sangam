...
- [ ] Unify the new ivory + teal + saffron palette across high-traffic app areas and remove obvious maroon holdouts
...
- [ ] Rebrand `Parampara Library` to `Parampara Pathshala` and switch it to tradition-first navigation
