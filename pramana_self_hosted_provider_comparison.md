...
| :--- | :---: | :---: | :---: | :---: | :--- |
| `pathshala_gita` | 100% | 100% | 6 | 0 | 🟢 Real Live Run |
| `bhakti_katha` | 100% | 100% | 6 | 0 | 🟢 Real Live Run |
| `bhakti_panchatantra` | 100% | 67% | 6 | 0 | 🟢 Real Live Run |
| `pathshala_upanishads` | 100% | 38% | 16 | 0 | 🟢 Real Live Run |
| `sikh_gurbani` | 100% | 33% | 0 | 0 | 🛑 Fallback to Mock |
