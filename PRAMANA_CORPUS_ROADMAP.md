...
| P3 | High-value Hindu expansion | Add Yoga Sutras and Ramayana as proper RAG corpora |
...
| Ramayana | Partial structure/companion flow | Kanda/Sarga/Shloka corpus path | High devotional and family-learning value |
...
|---|---|---|---|
| Hindu / Sanatan | Strongest because of Gita | Upanishads still curated/sample-scale; Yoga/Ramayana missing | Finish Upanishads, then Yoga Sutras/Ramayana |
...
| 90 days | P3 buildout | Yoga Sutras corpus and first Ramayana RAG slice |
